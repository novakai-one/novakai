...
**All five register keystones are now fixed** (F-19 + F-01…F-04). Remaining: gaps F-05…F-15,
hygiene F-16…F-18 — S-cost, mostly test-authoring; order and repros in `04-findings.md`.
