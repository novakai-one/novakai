...
Companion artifact: `docs/novakai/parity-checklist.md` — the recomputed per-feature
...
`docs/novakai/mvp-roadmap.json` to assert unfold-primary boot: this design doc + the parity
...
added as each plan is authored. `novakai:roadmap:audit` stays clean (this doc and the
