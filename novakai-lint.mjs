#!/usr/bin/env node
/* =====================================================================
   novakai-lint.mjs — static checker for Novakai .mmd files
   ---------------------------------------------------------------------
   Predicts the "Tidy spreads it out" failure BEFORE you load the file,
   by reproducing the classification in novakai/src/io/layout.ts:
   ...
   Usage:  node novakai-lint.mjs path/to/diagram.mmd [...more]
