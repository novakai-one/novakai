...
/* =====================================================================
   ...
   re-runs the experiment on demand, mechanically:
     ...
     for each corpus mutation (tools/flowmap/verify/mutations.json):
   ...
   Usage:
     node mutate.mjs [--corpus tools/flowmap/verify/mutations.json]
...
const CORPUS = arg('--corpus', join(ROOT, 'tools', 'flowmap', 'verify', 'mutations.json'));
