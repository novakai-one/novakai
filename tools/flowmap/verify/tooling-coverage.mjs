...
/* =====================================================================
   ...
   tooling map (docs/flowmap/_tooling.mmd).
   ---------------------------------------------------------------------
   The src map is gated by ts-morph (flowmap:gate). The dev-time tooling
   ...
   Usage:
     node tooling-coverage.mjs [--map docs/flowmap/_tooling.mmd]
                               [--tools tools]
                               [--allow docs/flowmap/tooling-curation-allowlist.txt]
                               [--json]
...
const MAP = arg('--map', 'docs/flowmap/_tooling.mmd');
const TOOLS = arg('--tools', 'tools');
const ALLOW = arg('--allow', 'docs/flowmap/tooling-curation-allowlist.txt');
