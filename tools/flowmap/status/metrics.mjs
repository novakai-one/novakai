...
/* =====================================================================
   ...
   events via lib/metrics-log.mjs into docs/flowmap/metrics/
   ...
   Root resolution matches the gates: FLOWMAP_ROOT (hermetic test seam)
...
function runSummary() {
  ...
  console.log('=== flowmap metrics — compliance over recorded runs ===');
