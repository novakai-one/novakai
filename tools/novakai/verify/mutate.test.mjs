/* =====================================================================
   ...
   The REAL corpus (tools/novakai/verify/mutations.json) is deliberately NOT run
   ...
   on demand: `npm run novakai:mutate` / `npm run novakai:mutate:full`.
   ===================================================================== */
...
function runMutate(dir, corpusObj) {
  ...
  return spawnSync('node', [join('tools', 'novakai', 'verify', 'mutate.mjs'),
