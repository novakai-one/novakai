#!/usr/bin/env node
/* =====================================================================
   ship-stamp.mjs — records the src/ content hash `novakai:ship` just
   ...
   Runs as the last step of novakai:ship:steps (package.json). Writes
   docs/novakai/ship-stamp.json — committed alongside the map/code it
   was generated from.
   ...
   `novakai:ship` would always dirty the stamp file and break ship
