/* =====================================================================
   ...
   one JSONL line to docs/novakai/metrics/session-log.jsonl so trust can
   ...
   NOVAKAI_METRICS_DEBUG=1 prints emit errors to stderr for development.
   ...
   The log lives under root/docs/novakai/metrics/ — root is the explicit
   argument, else NOVAKAI_ROOT (the gates' hermetic test seam), else the
