/* roadmap.test.mjs — deny-path acceptance for the roadmap/status computer
   (AUD5 fix for finding F-04, docs/novakai/audit/04-findings.md).
   ...
   novakai:roadmap:audit CI gate. AUD3 proved it had NO test: hard-wiring the
...
test('the repo\'s real roadmaps still compute clean under the tightened predicates', () => {
  // cmd checks are skipped-as-manual here (NOVAKAI_ROADMAP_SKIP_CMD): a
