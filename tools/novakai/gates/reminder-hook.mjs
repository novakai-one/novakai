...
/* =====================================================================
   ...
   <ROOT>/.novakai-reminders.json (ROOT resolved the same way as
   turn-gate.mjs: NOVAKAI_ROOT env var, else repo root). Every Nth call
   (N = NOVAKAI_REMINDER_EVERY env var, default 2) it fires: prints one
